...
-- Feed map fallback: preserve exact listing coordinates when available and otherwise
-- expose the verified Quintana Roo locality/zone centroid already maintained by
-- marketplace_qroo_mapped_listings. No exact property coordinate is invented.
