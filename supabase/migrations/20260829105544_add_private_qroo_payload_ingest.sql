-- Private Q.Roo ingest transport target.
-- Payloads arrive only through a GitHub-OIDC-authenticated Edge Function.
-- Client roles cannot execute this RPC directly.
