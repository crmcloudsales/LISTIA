...
def build_worker(html:str,marketplace_html:str,marketplace_css:str,marketplace_js:str,affiliate_html:str,affiliate_icon_svg:str,site_logo_svg:str,investment_html:str,footer_js:str,global_locales_js:str,japanese_js:str,terms_html:str,privacy_html:str,legal_css:str,logo_b64:str,listia_mark_b64:str,wordmark_light_b64:str,wordmark_dark_b64:str,favicon_b64:str)->str:
    ...
    investment_html=investment_html.replace('src="/listia-mark-transparent.webp"',f'src="data:image/webp;base64,{logo_b64}" data-cloudco-logo-fallback="/listia-mark-transparent.webp?v=2"')
...
const investmentHeaders={...commonHeaders,'permissions-policy':'camera=(), microphone=(), geolocation=()','x-robots-tag':'index, follow, max-image-preview:large','content-security-policy':"default-src 'self'; img-src 'self' data: https://upload.wikimedia.org; style-src 'unsafe-inline'; script-src 'unsafe-inline'; connect-src 'self'; object-src 'none'; base-uri 'none'; frame-ancestors 'none'; form-action 'self'"};
