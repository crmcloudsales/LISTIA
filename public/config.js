...
(() => {
  const styles = [
    ...
    ["listiaMarketplaceSavedStyles", "/marketplace-saved.css?v=2"],
    ...
    ["listiaControlCenterStyles", "/control-center.css?v=1"],
    ["listiaPropertyCompleteStyles", "/property-complete.css?v=1"],
...
(() => {
  const modules = [
    ...
    ["/property-complete.js?v=1", "listiaPropertyCompleteLoader"],
    ["/draft-actions.js?v=2", "listiaDraftActionsLoader"],
    ["/property-complete-integration.js?v=1", "listiaPropertyCompleteIntegrationLoader"],
    ...
    ["/listia-voice.js?v=5", "listiaVoiceLoader"],
    ...
    ["/marketplace-saved.js?v=1", "listiaMarketplaceSavedLoader"],
    ["/account-mode.js?v=1", "listiaAccountModeLoader"],
    ["/marketplace-auth-bridge.js?v=1", "listiaMarketplaceAuthBridgeLoader"],
    ["/pwa-fixes.js?v=1", "listiaPwaFixesLoader"],
    ["/app-shell-v2.js?v=2", "listiaAppShellV2Loader"],
    ["/listing-workspace.js?v=2", "listiaListingWorkspaceLoader"],
    ["/listings-v2.js?v=4", "listiaListingsV2Loader"],
    ["/billing-management.js?v=1", "listiaBillingManagementLoader"],
    ["/assistant-intelligence.js?v=4", "listiaAssistantIntelligenceLoader"],
    ["/ai-chat.js?v=3", "listiaAiChatLoader"],
    ["/control-center.js?v=2", "listiaControlCenterLoader"],
