const CACHE="listia-pwa-v0.15.0";
const CORE=[
  ...
  "/i18n-extra.js","/i18n.js?v=0.9.5","/global-locales.js?v=2","/japanese-locale.js?v=1","/listia-voice.js?v=2","/marketplace-assistant.js?v=1","/marketplace-feed-enhancements.js?v=2","/marketplace.js?v=1","/account-mode.js?v=1","/pwa-fixes.js?v=1",
