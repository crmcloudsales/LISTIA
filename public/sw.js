const CACHE="listia-pwa-v0.13.0";
const CORE=[
  "/","/index.html","/styles.css?v=0.9.3","/readability.css?v=3","/pwa-components.css?v=1","/account-marketplace.css?v=1","/marketplace.css?v=1","/billing.css?v=1","/billing.js?v=1","/runtime.js?v=1",
  "/i18n-extra.js","/i18n.js?v=0.9.5","/global-locales.js?v=2","/japanese-locale.js?v=1","/listia-voice.js?v=2","/marketplace-assistant.js?v=1","/marketplace.js?v=1","/account-mode.js?v=1","/pwa-fixes.js?v=1",
