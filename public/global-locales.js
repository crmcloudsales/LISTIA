  ...
  const EXTRA = {
    ...
    he: {
      ...
      strings: {
        ...
        'signup.eyebrow':'מתחילים','signup.title':'יצירת חשבון','signup.subtitle':'אנחנו צריכים רק את הפרטים הבסיסיים כדי לפתוח את סביבת העבודה שלך.','signup.name':'שם','signup.name_placeholder':'השם שלך','signup.email':'דואר אלקטרוני','signup.password':'סיסמה','signup.password_placeholder':'לפחות 8 תווים','signup.terms':'אני מסכים לתנאים ולמדיניות הפרטיות.','signup.submit':'צור את החשבון שלי','signup.have_account':'כבר יש לי חשבון',
    ...
    'zh-CN': {
      ...
      strings: {
        ...
        'signup.eyebrow':'开始','signup.title':'创建账户','signup.subtitle':'我们只需要基本信息来创建您的工作区。','signup.name':'姓名','signup.name_placeholder':'您的姓名','signup.email':'电子邮箱','signup.password':'密码','signup.password_placeholder':'至少 8 个字符','signup.terms':'我接受条款和隐私政策。','signup.submit':'创建我的账户','signup.have_account':'我已有账户',
